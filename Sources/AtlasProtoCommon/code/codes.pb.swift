...
public enum Code_ErrorCode: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  public static let allCases: [Code_ErrorCode] = [
    .success,
    .systemInvalidParams,
    .systemInternalError,
    .systemNotFound,
...
extension Code_ErrorCode: SwiftProtobuf._ProtoNameProviding {
